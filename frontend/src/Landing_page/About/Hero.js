  ...
  return (
    <div className="container">
      <div className="row p-3 p-md-5 mt-3 mt-md-5 mb-3 mb-md-5">
        <h1 className="text-center fs-4 fs-md-3">
          We pioneered the discount broking model in India.
          <br />
          Now, we are breaking ground with our technology.
        </h1>
      </div>
      <div className="row p-3 p-md-5 mt-3 mt-md-5 border-top text-muted" style={{ lineHeight: "1.8", fontSize: "1em" }}>
        <div className="col-12 col-lg-6 p-3 p-md-5 mb-4 mb-lg-0">
          <p>
